...
class wavefunction
{
 ...
 void initwf(grid g, int inittype, double width, double k, double time,const wavefunction &wf);


 void initwfeven(grid g, int inittype, double width, double k, double time);


 void initwfodd(grid g, int inittype, double width, double k, double time,const wavefunction &wf);

 void initplane(grid g, int inittype, double width, double time);

wavefunction rotate(grid g,grid gone);
 ...
 wavefunction alog(grid g, double deltat);
   ...
   complex<double>  autocorrelationsecond(grid gbig,const wavefunction &wf,long posinterest);
complex<double>  autocorrelationleinatpt(grid gbig,const wavefunction &wfinibig,const wavefunction &wf,long posinterest);

complex<double>  projection(grid gbig,const wavefunction &wfplane);

complex<double>  autocorrelationnew(grid gbig,const wavefunction &wf,const wavefunction &wfini);
...
complex<double>  tsurff(grid gbig,grid gbigone,const wavefunction &wf, double k, double posofinterest);
